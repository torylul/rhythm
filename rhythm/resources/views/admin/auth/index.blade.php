...
@section('title', 'Админ авторизация')
...
@section('content')
    ...
    <div class="pt-5 pb-5 div_auth_reg h-100">
        <div class="mx-auto pt-3 div_a_r">
            ...
            <form method="POST" action="{{route('admin.auth.check')}}" class="form_auth_reg mx-auto">
                @csrf
                ...
                @enderror
                <br>
                <button type="submit" class="btn btn-light btn_a_r rounded-pill" id="submit_form">Авторизация</button>
            </form>
        </div>
    </div>
