...
@section('title', 'Создание зала')

@section('content')

    <div class="container min-vh-100">
        <div class="pb-2 pt-2">
            <a href="{{ route('admin.hall') }}" class="btn btn-light"><i class="fa fa-chevron-left"
                                                                           aria-hidden="true"></i></a>
        </div>
        <form method="POST" action="{{ route('admin.hall.store') }}"
              class="w-50 mx-auto" enctype="multipart/form-data">
            @csrf
            <h1 class="h3 mb-3 fw-normal text-center">Создать зал</h1>
